...
public class WebElementCommansDemo3 {
	...
	public static void main(String[] args) {
		...
		// We use getAttribute(); method. hidden text will always get stored in "value"
		// attribute
		...
		// getAttribute() will give us the value of the attribute we provide. could be
		// any attribute
		...
		// If this causes the current page to change, it will wait for the new page to
		// load.
